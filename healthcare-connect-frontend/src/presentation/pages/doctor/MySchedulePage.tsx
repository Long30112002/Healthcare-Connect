...
const MySchedulePage = () => {
    ...
    const stats = [
        ...
        { value: schedules.filter(s => s.status === 'CANCELLED').length, label: t('schedule.cancelled'), color: 'gray' as const, loading },
        { value: schedules.filter(s => s.status === 'EXPIRED').length, label: t('schedule.expired'), color: 'gray' as const, loading },
    ];
