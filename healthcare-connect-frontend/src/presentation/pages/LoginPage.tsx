...
const LoginPage = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-blue-700 to-cyan-500 p-4 relative">
            {/* Nút chuyển ngôn ngữ - Góc trên bên phải */}
                ...
                <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 animate-fade-in">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full py-3 pl-10 pr-12 text-base border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition duration-200 outline-none"
                                    placeholder="••••••••"
                                    value={password}
                        ...
                        <div className="flex items-center justify-between">
                            <label className="flex items-center cursor-pointer">
                                ...
                                <span className="ml-2 text-sm text-gray-600">{t('page.login.rememberMe')}</span>
                            </label>
                            <a href="#" className="text-sm text-primary hover:text-blue-700 font-medium transition">
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-gray-600">
                            ...
                            <a href="#" className="text-primary hover:text-blue-700 font-medium transition">
                                {t('page.login.signUp')}
                            </a>
                        </p>
                    </div>
